...
// Used to get the edit timestammps of files
#include <sys/stat.h>
...
#define SM_TRACE(msg,...) _log("TRACE: ", msg, TEXT_COLOR_GREEN, ##__VA_ARGS__); // ## for Linux support
#define SM_WARN(msg,...) _log("WARNING: ", msg, TEXT_COLOR_YELLOW, ##__VA_ARGS__); // ## for Linux support
#define SM_ERROR(msg,...) _log("ERROR: ", msg, TEXT_COLOR_RED, ##__VA_ARGS__); // ## for Linux support

// Multiline define. Fancy
...
BumpAllocator make_bump_allocator(size_t size)
{
    ...
    {
        ba.capacity = size;
        memset(ba.memory, 0, size); // Sets nem to 0
    }
    else
    {
